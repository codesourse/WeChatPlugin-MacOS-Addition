...
static NSString * const kTKAutoOpenCameraEnableKey = @"kTKAutoOpenCameraEnableKey";
static NSString * const kTKAutoSayEnableKey = @"kTKAutoSayEnableKey";
...
- (instancetype)init {
    ...
    if (self) {
        ...
        _autoOpenCameraEnable = [[NSUserDefaults standardUserDefaults] boolForKey:kTKAutoOpenCameraEnableKey];
        _autoSayEnable = [[NSUserDefaults standardUserDefaults] boolForKey:kTKAutoSayEnableKey];
...
- (void)setAutoOpenCameraEnable:(BOOL)autoOpenCamera {
    _autoOpenCameraEnable = autoOpenCamera;
    [[NSUserDefaults standardUserDefaults] setBool:autoOpenCamera forKey:kTKAutoOpenCameraEnableKey];
    [[NSUserDefaults standardUserDefaults] synchronize];
}

- (void)setAutoSayEnable:(BOOL)autoSayEnable{
    _autoSayEnable = autoSayEnable;
    [[NSUserDefaults standardUserDefaults] setBool:autoSayEnable forKey:kTKAutoSayEnableKey];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
